<footer class="bg-gradient-to-b from-green-700 via-green-600 to-green-700 dark:bg-green-900">
    <div class="mx-auto px-8 md:px-16 lg:px-24 pt-16 pb-4">
        <div class="flex flex-col lg:flex-row mb-20">
            <div class="lg:w-1/2 mb-10 lg:mb-0">
                <div class="flex items-center justify-center">
                    <img src="{{ asset('img/logobalangan.webp') }}" alt="logo balangan" class="mb-4 h-14 mr-2">
                    <img src="{{ asset('img/logo.png') }}" alt="logo kularakat" class="mb-4 h-[5.5rem] mr-2">
                </div>
                <p class="text-white text-md text-left md:text-center font-semibold space-y-2">
                  Dinas Pekerjaan Umum, Penataan Ruang, Perumahan
                  Rakyat dan Kawasan Permukiman Kabupaten Balangan<br class="hidden sm:block" />
                </p>
                <p class="text-white text-sm lg:text-md text-left md:text-center space-y-2">
            ...
            <div class="lg:w-1/2">
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full lg:w-7/12 px-6 mb-6 lg:mb-0 text-white">
                    ...
                    <div class="w-full lg:w-5/12 px-6 text-white">
                        <h5 class="text-lg font-semibold mb-4">Support</h5>
                        <nav class="space-y-2">
                            <a href="#" class="block text-gray-600 hover:text-yellow-400 transition-colors duration-200" data-bs-toggle="modal" data-bs-target="#contact">Contact Support</a>
                            <a href="https://www.lapor.go.id/instansi/pemerintah-kabupaten-balangan" class="block text-gray-600 hover:text-yellow-400 transition-colors duration-200" target="_blank">Layanan LAPOR !</a>
                            <a href="#" class="block text-gray-600 hover:text-yellow-400 transition-colors duration-200" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a>
                        </nav>
                    </div>
                </div>
            </div>
    ...
    <div class="py-4">
      <div class="mx-auto">
          <div class="text-center text-white">
              Copyright &copy; 2024 All rights reserved | Kula Rakat 2.0
          </div>
      </div>
    </div>
