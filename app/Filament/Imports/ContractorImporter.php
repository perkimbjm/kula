...
class ContractorImporter implements WithHeadingRow, WithStartRow, ToModel, WithBatchInserts
{
    ...
    public function model(array $row)
    {
        try {
            ...
            Log::info('Mapped contractor data:', $mappedRow);
            ...
            Log::error('Error processing contractor row:', [
                'row' => $row,
                'error' => $e->getMessage(),
