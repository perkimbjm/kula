...
use App\Filament\Imports\ConsultantImporter;
use App\Filament\Exports\ConsultantExporter;
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('export')
                ...
                ->form([
                    CheckboxList::make('selectedColumns')
                        ...
                        ->options(function () {
                            return collect(ConsultantExporter::getColumns())->mapWithKeys(function ($column) {
                                return [$column->getName() => $column->getLabel()];
                            })->toArray();
                        })
                        ->default(function () {
                            return collect(ConsultantExporter::getColumns())
                ...
                ->action(function (array $data) {
                    try {
                        ...
                        return Excel::download(
                            new ConsultantExporter($filters, $selectedColumns),
                            'data_konsultan_' . now()->format('Y-m-d_His') . '.xlsx'
                        );
                    } catch (\Exception $e) {
                        Notification::make()
                            ->danger()
            ...
            Actions\Action::make('import')
                ...
                ->action(function (array $data) {
                    try {
                        if (isset($data['file'])) {
                            ...
                            Log::info('Starting consultant import process for file:', ['file_path' => $filePath]);

                            // Import the file
                            Excel::import(new ConsultantImporter(), $filePath);

                            // Notification for success
                            Notification::make()
                                ->success()
                                ->title('Data konsultan berhasil diimport!')
                                ->send();
                        } else {
                        ...
                        Log::error('Consultant import error: ' . $e->getMessage());
                ...
                ->modalHeading('Import Data Konsultan')
            ...
            Actions\Action::make('downloadTemplate')
                ...
                ->color('danger')
                ->url('/data/template_konsultan.xlsx')
