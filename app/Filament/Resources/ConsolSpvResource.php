...
use App\Filament\Resources\ConsolSpvResource\Pages;
use App\Filament\Resources\ConsolSpvResource\RelationManagers;
...
class ConsolSpvResource extends Resource
{
    ...
    protected static ?string $label = 'Konsolidasi Paket Pengawasan';
    ...
    {
        return [
            'index' => Pages\ListConsolSpvs::route('/'),
            'create' => Pages\CreateConsolSpv::route('/create'),
            'edit' => Pages\EditConsolSpv::route('/{record}/edit'),
        ];
    }
}
